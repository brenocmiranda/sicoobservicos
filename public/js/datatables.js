...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var btnFilter = '<button class="btn btn-lg btn-icon icon-left btn-default btn-outline waves-effect waves-light" data-toggle="modal" data-target="#modal-filtros"><i class="fa fa-filter py-1"></i> <span class="hidden-xs">Filtrar</span></button>';
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var div = $('<div class="d-none"><label/></div>').addClass( classes.sLength );
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": ordenado de modo crescente",
				 ...
				 *    } );
				 */
				"sSortDescending": ": ordenado de modo decrescente"
			},
			 ...
			 *    } );
			 */
			"sEmptyTable": "Não foi encontrado nenhum dado na tabela.",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "Visualizando 0 a 0 de 0 registros",
				...
				var attach = function( container, buttons ) {
					...
					for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
						...
						if ( $.isArray( button ) ) {
							...
							if ( btnDisplay !== null ) {
								node = $('<a>', {
										'class': classes.sPageButton+' btn btn-xs '+btnClass,
