...
class Associados extends Model
{
    ...
    public function RelationUnidade(){
        return $this->belongsTo(Unidades::class, 'cli_id_associado', 'id');
    }

    public function RelationEnderecos(){
        return $this->belongsTo(Enderecos::class, 'cli_id_associado', 'id');
    }

    public function RelationTelefones(){
        return $this->belongsTo(Telefones::class, 'cli_id_associado', 'id');
    }

    public function RelationEmails(){
        return $this->belongsTo(Emails::class, 'cli_id_associado', 'id');
    }
}
