...
class Associados extends Model
{
    ...
    protected $fillable = ['id', 'id_sisbr', 'nome', 'nome_fantasia', 'representante', 'documento', 'tipo_renda', 'renda', 'cod_cnae', 'data_nascimento', 'atividade_economica', 'sexo', 'sigla', 'funcionario', 'data_relacionamento', 'data_renovacao', 'PA', 'nome_gerente', 'descricao_identidade', 'numero_identidade', 'politicamente_exposta', 'profissao', 'naturalidade', 'perfil_tarifario', 'created_at', 'updated_at'];
    ...
    public function RelationSipag(){
        return $this->hasMany(ProSipag::class, 'cli_id_associado');
    }
