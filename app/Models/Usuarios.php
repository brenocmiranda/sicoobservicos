...
class Usuarios extends Authenticatable
{
    ...
    protected $fillable = ['id', 'login', 'password', 'email', 'email_verified_at', 'attempts', 'telefone', 'telefone_corporativo', 'telefone_ramal', 'remember_token', 'status', 'usr_id_setor', 'usr_id_funcao', 'usr_id_instituicao', 'usr_id_unidade', 'cli_id_associado', 'id_imagem', 'created_at', 'updated_at'];
