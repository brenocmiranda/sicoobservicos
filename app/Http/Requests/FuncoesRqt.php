...
class FuncoesRqt extends FormRequest
{
    /**
    ...
    public function rules()
    {
        if($this->segment(5) == 'adicionar'){
            return ['nome' => 'required|min:3|unique:usr_funcoes,nome',
                'status' => 'nullable',
            ];
        }else{
            return ['nome' => 'required|min:3|unique:usr_funcoes,nome,'.$this->segment(6).',id',
                'status' => 'nullable',
            ];
        }
    }
