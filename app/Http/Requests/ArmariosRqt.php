...
class ArmariosRqt extends FormRequest
{
    /**
    ...
    {   
        ...
        if ($this->segment(5) == "adicionar"){
            return ['nome' => 'required|min:3',
                'referencia' => 'required|unique:cre_armarios,referencia',
                'status' => 'nullable',
            ];
        }else{
            return ['nome' => 'required|min:3',
                'referencia' => 'required|unique:cre_armarios,referencia,'.$this->segment(6).',id',
                'status' => 'nullable',
            ];       
        }
