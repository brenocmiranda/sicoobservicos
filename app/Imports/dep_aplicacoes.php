        ...
        {   
            ...
            if(isset($dados)){
                ...
                Aplicacoes::create([
                    ...
                    'valor_saldo' => number_format($row['valor_saldo_diario'], 2, '.', ''),
                    'data_movimento' => gmdate('Y-m-d', (($row['data_movimento'] - 25569) * 86400)),
                    'cco_id_contacorrente' => (ContaCorrente::where('num_contrato', $row['numero_conta_corrente'])->count() > 0 ? ContaCorrente::where('num_contrato', $row['numero_conta_corrente'])->select('id')->first()->id : null),
