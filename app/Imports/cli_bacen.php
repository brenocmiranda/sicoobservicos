    ...
    */
    public function collection(Collection $rows)
    {
        ...
        {  
            ...
            $dados = AssociadosBacen::where('cli_id_associado', $associado->id)->first();
            if(isset($dados)){
                AssociadosBacen::where('cli_id_associado', $associado->id)->delete();
                AssociadosBacen::create([
                    ...
                    'saldo_vencido_ate90' => number_format($row['valor_vencido_ate_90_dias_sfn'], 2, '.', ''),
                    'saldo_vencido_acima90' => number_format($row['valor_vencido_acima_90_dias_sfn'], 2, '.', ''),
