		...
		<div class="page py-5">
			...
			<div class="text-center pt-5 mx-auto">
				@foreach($result as $aniversario)
					<h2 style="font-size: 36px; line-height: 1.5em">{{$aniversario->nome}} - {{date('d/m', strtotime($aniversario->data_nascimento))}}</h2>
				@endforeach
			</div>
			<div class="row col-12 mr-auto footer">
				<img src="{{asset('public\img\footer-aniv.png')}}" style="width: 100%;">
			</div>
		</div>
	</section>
</div>
