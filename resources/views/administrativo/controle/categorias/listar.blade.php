	...
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				...
				<li><a href="javascript:void(0)">Materiais</a></li>
			...
			<div class="h-100 row col">
				<div class="col-lg-12 position-absolute">
					<div class="row mx-auto">
						<button class="btn btn-primary btn-outline ml-auto" id="adicionar" name="adicionar" title="Adicionar nova categoria" data-toggle="modal" data-target="#modal-adicionar" style="z-index: 10">
...
@section('modal')
	@include('administrativo.controle.categorias.adicionar')
	@include('administrativo.controle.categorias.editar')
	@include('administrativo.controle.categorias.detalhes')
@endsection
...
<script type="text/javascript">
	$(document).ready( function (){
		...
		$('#table').DataTable({
			...
			searching: true,
			destroy: true,
			ajax: "{{ route('listar.categorias.materiais') }}",
			serverSide: true,
			"columns": [ 
			{ "data": "id","name":"id"},
		...
		$('#modal-adicionar #formAdicionar').on('submit', function(e){
			...
			e.preventDefault();
			$.ajax({
				url: '{{ route("adicionar.categorias.materiais") }}',
				type: 'POST',
