...
@section('modal')
	@include('configuracoes.administrativo.usuarios.adicionar')
	@include('configuracoes.administrativo.usuarios.editar')
	@include('configuracoes.administrativo.usuarios.detalhes')
	@include('configuracoes.administrativo.usuarios.alterar')
@endsection
