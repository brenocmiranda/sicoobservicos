                                ...
                                <li class="col-12">
                                    <div class="col-12 row mx-auto p-0">
                                        <div class="col-8 p-0">
                                            ...
                                            <input type="file" name="pro_cobranca" accept=".xlsx">
                                        </div>
                                        <div class="col-4 p-0 m-auto text-right">
                                            <label class="mb-0 d-block">
                        ...
                        <div id="section-2" class="tab-pane">
                            <ul class="row col-12 mx-auto p-0 text-left">
                                ...
                                <li class="col-12">
                                    <div class="col-12 row mx-auto p-0">
                                        <div class="col-8 p-0">
                                            <label class="col-form-label mb-2 p-0">pro_sipag_faturamento.xlsx</label>
                                            <input type="file" name="pro_sipag_faturamento" accept=".xlsx">
                                        </div>
                                        <div class="col-4 p-0 m-auto text-right">
                                            <label class="mb-0 d-block">
                                                <b>{!! ( strtotime(date('Y-m-d', strtotime(@$pro_sipag->updated_at))) == 
