											...
											<div class="p-3 h-100 row">
												<div class="text-left col-lg-8 col-8">
													...
													<label class="text-truncate d-block">
														<small class="text-dark"><b>Data de fechamento:</b> {{$chamado->RelationStatus->first()->pivot->created_at->format('d/m/Y H:i')}} - {{$chamado->RelationStatus->first()->pivot->created_at->subMinutes(2)->diffForHumans()}}</small></small>
													</label>	
													@endif					
												</div>
