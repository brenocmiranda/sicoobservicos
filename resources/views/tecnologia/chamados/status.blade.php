              ...
              <div class="row">
                ...
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control form-control-line" name="descricao" placeholder="Escreva aqui um descrição para o colaborador..." rows="4">Estado do chamado alterado por {{Auth::user()->RelationAssociado->nome}}.</textarea>
                  </div>
                </div>
              </div>
            </div>
