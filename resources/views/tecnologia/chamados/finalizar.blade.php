              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control form-control-line" name="descricao" placeholder="Descreva a solução..." rows="4" required  onkeyup="this.value = this.value.toUpperCase();"></textarea>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <div class="row col-12 mt-3 preview mx-0 p-0">
                      <div class="border mx-2 rounded col-lg-2 col-4 row p-0 mb-4" style="height: 7em;">
                        ...
                        <input type="file" class="px-0 col-12 position-absolute mx-auto h-100 pointer" style="opacity: 0; top: 0%; left: 0%" id="addArquivoFinalizar" title="Selecione os anexos do tópico" multiple>
                      </div>
                    </div> 
                  </div>
                </div>
