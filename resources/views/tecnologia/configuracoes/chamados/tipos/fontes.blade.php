<!-- Modal -->
<div class="modal fade" id="modal-fonte" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" data-backdrop="static" style="overflow-y: hidden;">
  <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form-sample" id="formFonte" enctype="multipart/form-data" autocomplete="off">
        @csrf
              ...
              <div class="row">
                <div class="col-8">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-line" name="nome" placeholder="SISBR 2.0" required/>
                  </div>
                </div>
                <div class="col-10">
                  <div class="form-group">
