    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Adicionar atalho</h5>
        </div>
                ...
                <div class="col-8 p-0">
                  ...
                  <div class="col-11">
                    <div class="form-group">
                      ...
                      <input class="form-control form-control-line" name="endereco" placeholder="Página de login" required/>
                    </div>
                  </div>
                </div>
                <div class="col-4 p-0">
                    ...
                    <div>
                      ...
                      <div>
                        <div class="btn btn-secondary btn-outline btn-image px-3 rounded-circle">
                          <input type="file" class="px-0 position-absolute m-auto" accept=".png, .jpg, .jpeg .ico" name="upload_img" id="upload_img_add" onchange="image(this);">
