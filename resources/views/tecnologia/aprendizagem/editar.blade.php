                ...
                <div class="form-group">
                  ...
                  <div class="row col-12 mt-3 preview mx-0 p-0">
                    ...
                    <div class="border mx-2 mb-4 rounded col-lg-2 col-4 p-0 row text-center" id="PreviewImage{{$arquivos->id}}"> 
                      ...
                      <a href="javascript:void(0)" onclick="removeImagem({{$arquivos->id}})" class="btn btn-light rounded-circle m-n2 mb-auto border btn-xs position-absolute" style="z-index: 10"><i class="mdi mdi-close"></i></a>
