...
@section('modal')
	@include('gestao.chamados.status.adicionar')
	@include('gestao.chamados.status.editar')
	@include('gestao.chamados.status.detalhes')
@endsection
...
<script type="text/javascript">
	$(document).ready( function (){
		...
		$('#table tbody').on('click', 'button#alterar', function () {
			...
			$(this).parent('tr').addClass('selected');
			var data = table.row('tr.selected').data();
			var url = "{{url('app/gestao/chamados/status/alterar')}}/"+data.id;
			swal({
