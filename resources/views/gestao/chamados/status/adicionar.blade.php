    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Adicionar status</h5>
        </div>
              ...
              <div class="row">
                ...
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-line" name="nome" placeholder="Em aberto" required/>
                  </div>
                </div>
                <div class="col-3">
                  <div class="form-group">
                ...
                <div class="col-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-line colorpicker" name="color" required/>
                  </div>
                </div>
                <div class="col-12">
                  <div class="form-group">
                    <div class="checkbox checkbox-custom m-0">
                      <input id="checkbox1" type="checkbox" name="open">
                ...
                <div class="col-12">
                  <div class="form-group">
                    <div class="checkbox checkbox-custom m-0">
                      <input id="checkbox2" type="checkbox" name="finish">
