              ...
              <div class="row">
                ...
                <div class="col-8">
                  <div class="form-group">
                    ...
                    <div class="">
                      <input class="form-control form-control-line" name="nome" onkeyup="this.value = this.value.toUpperCase();" required/>
                    </div>
                  </div>
                </div>
                <div class="col-5">
                  <div class="form-group">
                    ...
                    <div class="">
                      <input class="form-control form-control-line" onkeyup="this.value = this.value.toUpperCase();" name="referencia" required/>
                    </div>
                  </div>
                </div>
