...
@section('modal')
	@include('gestao.administrativo.instituicoes.adicionar')
	@include('gestao.administrativo.instituicoes.editar')
	@include('gestao.administrativo.instituicoes.detalhes')
@endsection
