    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Editar de documento</h5>
        </div>
             ...
             <div class="row">
              <div class="col-8">
                <div class="form-group">
                  ...
                  <input class="nome form-control form-control-line" name="nome" onkeyup="this.value = this.value.toUpperCase();" placeholder="MODELO DE BORDERÔ" required/>
                </div>
              </div>
              <div class="col-10">
                <div class="form-group">
