    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Adicionar armário</h5>
        </div>
              ...
              <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-line" name="nome" placeholder="Emprestimos Consignados" onkeyup="this.value = this.value.toUpperCase();" required/>
                  </div>
                </div>
                <div class="col-5">
                  <div class="form-group">
                    <label class="col-form-label pb-0">Referência <span class="text-danger">*</span></label>
                    <input type="text" class="form-control form-control-line referencia" name="referencia" placeholder="AR05-GA06" max="9" required/>
                  </div>
                </div>
