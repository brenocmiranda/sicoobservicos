								...
								<tr>
									<td align="left" id="m_42936987098664594m_1127568141554999x_content-5" style="font-size:15px;font-family:Helvetica,Arial,sans-serif;line-height:25px;color:#222222">
										<div><span>
											...
											<label>Você acabou de ser cadastrado na plataforma <b>{{env('APP_NAME')}}</b>, faça o seu primeiro acesso utilizando os dados abaixo:</label>
											<br>
											<p style="text-align:justify">
												...
												<div>
													<label><b>Em seu primeiro <a href="{{route('login')}}">acesso a plataforma</a>, você terá que atualizar a sua senha, caso não consiga entre em contato com o administrador.</b></label>
												</div>
											</p>
