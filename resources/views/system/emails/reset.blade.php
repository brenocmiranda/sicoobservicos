								...
								<tr>
									<td align="left" id="m_42936987098664594m_1127568141554999x_content-5" style="font-size:15px;font-family:Helvetica,Arial,sans-serif;line-height:25px;color:#222222">
										<div><span>
											...
											<label>Você teve os seus dados de acessos atualizados na plataforma <b>{{env('APP_NAME')}}</b>. Entre com as informações abaixo e altere os dados:</label>
											<br>
											<ul>
											...
											<p style="text-align:justify">
												<div>
													<label><a href="{{route('login')}}">Acesse a plataforma e faça login.</a></label>
												</div>
											</p>
