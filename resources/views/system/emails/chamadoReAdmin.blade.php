				...
				<tr>
					<td style="padding: 20px 40px;">
						<font face="Helvetica,Arial,sans-serif" color="#222222" style="font-size:15px; line-height:25px;">
							...
							<p>
								Os problemas talvez não foram sanados totalmente e os problemas voltaram a ocorrer, entre em contato com o usuário responsável e tente solucionar os problemas.
							</p>
							<p>
								<ul>
