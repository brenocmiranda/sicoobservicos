...
<div class="container-fluid">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <ul class="nav nav-tabs customtab2 p-4 row justify-content-center" role="tablist" style="background: #38565a;border-radius: 10px;">
      ...
      <li role="presentation"> <a href="#carteiracredito" aria-controls="carteiracredito" role="tab" data-toggle="tab" aria-expanded="true"> <span>Emprestimo</span> </a> </li>
      ...
      <li role="presentation"> <a href="#consorcios" aria-controls="consorcios" role="tab" data-toggle="tab" aria-expanded="true"> <span>Consórcio</span> </a> </li> 
    ...
    <div class="tab-content white-box mt-0">
      ...
      <div role="tabpanel" class="tab-pane fade" id="cadastro">
        <div class="col-12"> 
          ...
          <div class="row">
            ...
            <div class="mt-5">
              <h5>Conta capital <small>Data base: {{date('d/m/Y', strtotime($cca_contacapital->data_movimento))}}</small></h5>
              <hr class="mt-2">
              <div class="col-12">
                <div class="row">
                  <div class="col-lg-3 col-12">
      ...
      <div role="tabpanel" class="tab-pane fade" id="consorcios">
        ...
        @foreach($associado->RelationConsorcios->sortByDesc('data_vigencia') as $consorcios)
        <div class="col-12"> 
          <div class="mb-5">
            <h5 class="font-weight-normal"><b>{{$consorcios->n_contrato}}</b> <small>({{$consorcios->versao}})</small></h5>
            <hr class="mt-2">
            <div class="row">
              <div class="col-lg-6 col-12">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-12">
                ...
                <label>{{(date('d/m/Y', strtotime($consorcios->data_cancelamento)) != '31/12/1899' ? date('d/m/Y', strtotime($consorcios->data_cancelamentoo)) : '-')}}</label>
              </div>
              <div class="col-lg-3 col-12">
                <h6>Valor contratado</h6>
      ...
      <div role="tabpanel" class="tab-pane fade" id="previdencias">
        ...
        <div class="col-12"> 
          <div class="mb-5">
            <h5 class="font-weight-normal"><b>{{$previdencias->n_registro}}</b> <small>({{$previdencias->situacao_participante}})</small></h5>
            <hr class="mt-2">
            <div class="row">
              <div class="col-lg-3 col-12">
