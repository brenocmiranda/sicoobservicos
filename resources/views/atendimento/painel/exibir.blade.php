...
<div class="container-fluid">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <ul class="nav nav-tabs customtab2 p-4 row justify-content-center" role="tablist" style="background: #38565a;border-radius: 10px;">
      ...
      <li role="presentation"> <a href="#contacorrente" aria-controls="contacorrente" role="tab" data-toggle="tab" aria-expanded="true"> <span>Contas corrente</span> </a> </li> 
      <li role="presentation"> <a href="#cartaocredito" aria-controls="cartaocredito" role="tab" data-toggle="tab" aria-expanded="true"> <span>Contas cartão</span> </a> </li> 
      ...
      <li role="presentation"> <a href="#previdencias" aria-controls="previdencias" role="tab" data-toggle="tab" aria-expanded="true"> <span>Previdência</span> </a> </li> 
    </ul>
    <!-- Tab panes -->
    <div class="tab-content white-box mt-0">
      ...
      <div role="tabpanel" class="tab-pane fade" id="cadastro">
        ...
        <div role="tabpanel" class="tab-pane fade" id="seguros">
          ...
          <div class="col-12"> 
            <div class="mb-5">
              <h5 class="font-weight-normal"><b>{{$seguros->familia}}</b> <small>({{$seguros->n_proposta}})</small></h5>
              <hr class="mt-2">
              <div class="row">
                <div class="col-lg-3 col-12">
                ...
                <div class="col-lg-3 col-12">
                  <h6 class="mt-lg-0">Corretora</h6>
                  <label>{{$seguros->corretora}}</label>
                </div>
                <div class="col-lg-3 col-12">
                  <h6 class="mt-lg-0">Seguradora</h6>
          ...
          <div class="col-12 px-0 px-lg-4"> 
            ...
            <div class="row mx-auto mb-5">
              <div class="col-lg-3 col-6">
                ...
                <a href="#contacorrente" aria-controls="contacorrente" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#consorcios" aria-controls="consorcios" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#contacapital" aria-controls="contacapital" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#carteiracredito" aria-controls="carteiracredito" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#cartaocredito" aria-controls="cartaocredito" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#previdencias" aria-controls="previdencias" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#poupanca" aria-controls="poupanca" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark">  
                  <div class="radio radio-success">
                    <input type="radio" checked>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#aplicacoes" aria-controls="aplicacoes" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark"> 
                  <div class="radio radio-success">
                    <input type="radio" checked>
                    <label> RDC </label>
                  </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <a href="#seguros" aria-controls="seguros" role="tab" data-toggle="tab" aria-expanded="true" class="text-dark"> 
                  <div class="radio radio-success">
                    <input type="radio" checked>
