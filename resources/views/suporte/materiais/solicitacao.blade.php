		...
		<div class="modal-content">
			...
			@csrf
				<div class="modal-body">
					<div class="card-body row mx-auto py-0">
										...
										<div class="col-lg-9 col-12">
						                  <div class="form-group">
						                    ...
						                    <div class="row m-0">
						                    	...
						                    	<select class="quantidade_tipo form-control form-control-line col-7">
						...
						<div class="col-lg-5 col-12 px-0">
							<div class="row col-12 mx-auto p-lg-0 px-5">
								<h6 class="col-form-label mt-0 mx-auto">Carrinho de materiais</h6>
								<hr class="col-6 my-2 pb-3">
								<div id="materiais" class="col-12 text-center"></div>
							</div>
						</div>
					</div>
				</div>
