             ...
             <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea class="motivo form-control form-control-line text-uppercase" name="motivo" rows="4" placeholder="Descreva o motivo do cancelamento da solicitação..." required></textarea>
                </div>
              </div>
            </div>
          </div>
