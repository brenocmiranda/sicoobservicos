<!-- Modal -->
<div class="modal fade" id="modal-cancelar" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true" data-backdrop="static">
  <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="form-sample" id="formCancelar" enctype="multipart/form-data" autocomplete="off">
        @csrf
             ...
             <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <textarea class="motivo form-control form-control-line" name="motivo" onkeyup="this.value = this.value.toUpperCase();" rows="4" placeholder="Descreva o motivo do cancelamento da solicitação..." required></textarea>
                </div>
              </div>
            </div>
          </div>
