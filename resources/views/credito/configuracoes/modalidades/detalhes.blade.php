    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Detalhes da modalidade</h5>
        </div>
          ...
          <div class="col-12 grid-margin mb-0">
            <div class="card-body py-0">
              <div class="row">
                ...
                <div class="col-5">
                  <div class="form-group">
                    <label class="col-form-label pb-0">Sigla</label>
                    <input class="form-control form-control-line sigla" name="sigla" disabled/>
                  </div>
                </div>
                <div class="col-5">
                  <div class="form-group">
