    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Editar modalidade</h5>
        </div>
              ...
              <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-line nome" name="nome" placeholder="0010-CCCP" onkeyup="this.value = this.value.toUpperCase();" required/>
                  </div>
                </div>
                <div class="col-5">
                  <div class="form-group">
                    <label class="col-form-label pb-0">Sigla <span class="text-danger">*</span></label>
                    <input class="form-control form-control-line sigla" name="sigla" placeholder="CCCP" onkeyup="this.value = this.value.toUpperCase();" required/>
                  </div>
                </div>
                <div class="col-5">
                  <div class="form-group">
