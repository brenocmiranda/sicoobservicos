    ...
    <div class="modal-content">
      <div class="modal-header d-block pb-0">
        <div class="col-12">
          ...
          <h5 class="modal-title">Adicionar finalidade</h5>
        </div>
              ...
              <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <input class="form-control form-control-line" name="nome" placeholder="CREDITO ROTATIVO" onkeyup="this.value = this.value.toUpperCase();" required/>
                  </div>
                </div>
