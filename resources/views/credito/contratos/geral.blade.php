...
<small class="section-header-breadcrumb d-flex">
	...
	<div class="breadcrumb-item d-flex active p-0">
		<a href="{{ route('exibir.contratos.credito') }}" class="p-0 d-block text-primary">Contratos de crédito</a>
	</div>
</small>
@endsection
		...
		<div class="card-body">
			<div class="h-100 d-flex">
				<div class="col-lg-12 d-flex">
					<div>
						<h3>Contratos</h3>
						<h6>Selecione uma das opções abaixo para visualizar os contratos.</h6>
					</div>
					<div class="ml-auto">
			...
			<div class="row justify-content-center">
				<div class="col-3 border rounded shadow-sm m-3 p-3">
					<a href="{{ route('exibir.vigentes.credito') }}" class="button-size">
						<div class="py-2 px-4 m-auto text-center">
							<i class="mdi mdi-package-variant" style="font-size: 30px;"></i>
						</div> 
						<div class="m-auto text-center">
							<h5 class="mb-1"> Contratos Vigentes </h5>
						</div>
					</a>
				</div>
				<div class="col-3 border rounded shadow-sm m-3 p-3">
					<a href="{{ route('exibir.liquidados.credito') }}" class="button-size">
						<div class="py-2 px-4 m-auto text-center">
							<i class="mdi mdi-package-variant-closed" style="font-size: 30px;"></i>
						</div>
						<div class="m-auto text-center">
							<h5 class="mb-1"> Contratos Liquidados </h5>
						</div>
					</a>
				</div>
				<div class="col-3 border rounded shadow-sm m-3 p-3">
					<a href="{{ route('exibir.prejuizo.credito') }}" class="button-size">
						<div class="py-2 px-4 m-auto text-center">
							<i class="mdi mdi-minus-circle-outline" style="font-size: 30px;"></i>
						</div>
						<div class="m-auto text-center">
							<h5 class="mb-1"> Contratos em Prejuízo </h5>
						</div>
					</a>
				</div>
				<form class="" id="formPesquisar">
					@csrf
					<div class="col-10 mx-auto my-2">
						<input type="search" name="pesquisar" id="pesquisar" aria-controls="table" placeholder="Pesquisar">
						<label>* Localize seus contratos pelo nome do associado, número do contrato, modalidade ou a sua situação.</label>
					</div>
				</form>
				<div class="m-3 col-12">
					<table class="table text-center d-none" id="table">
						<thead>
							<th> Nº contrato </th>
							<th> Associado </th>
							<th> Produto </th>
...
<script type="text/javascript">
	...
	$(document).ready( function(){
		...
		$('#pesquisar').on('keyup', function(){
			if(this.value != ""){
				$("#table").fadeIn("slow").removeClass('d-none');
				...
				$("#table").fadeIn("slow").addClass('d-none');
