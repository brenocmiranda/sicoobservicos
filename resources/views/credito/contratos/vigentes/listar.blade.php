...
<small class="section-header-breadcrumb d-flex">
	...
	<div class="breadcrumb-item d-flex active p-0">
		<a href="{{ route('exibir.vigentes.credito') }}" class="p-0 d-block text-primary">Vigentes</a>
	</div>
</small>
@endsection
			...
			<div class="h-100 d-flex">
				<div class="col-lg-12 d-flex">
					<div>
						...
						<h6>Estão listados a abaixo todos os contratos vigentes arquivados.</h6>
					</div>
					<div class="ml-auto">
...
<script type="text/javascript">
	...
	$(document).ready( function(){
		...
		$.ajax({
			url: '{{ route("listar.vigentes.credito") }}',
			type: 'GET',
