      ...
      <div class="modal-header d-block border-bottom-0 pb-0">
        ...
        <ul class="nav customtab col-12" role="tablist">
          <li role="presentation" class="active">
            <a href="#contratos-edit" aria-controls="contratos-edit" role="tab" data-toggle="tab" aria-expanded="true">
              <span class="visible-xs"><i class="ti-home"></i></span>
              <span class="hidden-xs"> Dados contratuais</span>
            </a>
          </li>
          <li role="presentation" class="">
            <a href="#garantias-edit" aria-controls="garantias-edit" role="tab" data-toggle="tab" aria-expanded="true">
              <span class="visible-xs"><i class="ti-home"></i></span>
              <span class="hidden-xs"> Garantias</span>
            </a>
          </li>
          <li role="presentation" class="">
            <a href="#complementares-edit" aria-controls="complementares-edit" role="tab" data-toggle="tab" aria-expanded="true">
              <span class="visible-xs"><i class="ti-home"></i></span>
              <span class="hidden-xs"> Complementares</span>
            </a>
          </li>
          <li role="presentation" class="">
            <a href="#observacoes-edit" aria-controls="observacoes-edit" role="tab" data-toggle="tab" aria-expanded="true">
              <span class="visible-xs"><i class="ti-home"></i></span>
          ...
          <div class="col-12 grid-margin mb-0">
            <div class="card-body py-3">
              <div class="tab-content mt-4" id="myTabContent">
                <!-- TAB1 -->
                <div class="tab-pane active in" id="contratos-edit" role="tabpanel" aria-labelledby="contratos-edit">
                  <div class="row">
                    <div class="col-3">
                      <div class="form-group">
                        <label class="col-form-label pb-0">Nº contrato <i class="text-danger">*</i></label>
                        <div class="">
                          <input class="num_contrato form-control form-control-line" name="num_contrato" max="9" required/>
                        </div>
                      </div>
                    </div>
                    <div class="col-9">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <div class="input-field mt-0">
                          <select class="cre_id_produtos form-control form-control-line" name="cre_id_produtos" required>
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <select class="cre_id_modalidades form-control form-control-line" name="cre_id_modalidades" required>
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="date" class="data_operacao form-control form-control-line" name="data_operacao" required/>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                        <label class="col-form-label pb-0">Data de vencimento <i class="text-danger">*</i></label>
                        <input type="date" class="data_vencimento form-control form-control-line" name="data_vencimento" required/>
                      </div>
                    </div>              
                    <div class="col-4">
                      <div class="form-group">
                        <label class="col-form-label pb-0">Valor da operação (R$)<i class="text-danger">*</i></label>
                        <input type="text" class="money valor_contrato form-control form-control-line" name="valor_contrato" required/>
                      </div>
                    </div>
                    <div class="col-8">
                      <div class="form-group">
                        <label class="col-form-label pb-0">Armário <i class="text-danger">*</i></label>
                        <select class="cre_id_armarios form-control form-control-line" name="cre_id_armarios" required>
                ...
                <!-- TAB2 -->
                <div class="tab-pane" id="garantias-edit" role="tabpanel" aria-labelledby="garantias-edit">
                  <div class="py-2">
                ...
                <!-- TAB3 -->
                <div class="tab-pane" id="complementares-edit" role="tabpanel" aria-labelledby="complementares-edit">
                  <div class="row">
                    <div class="col-9">
                      <div class="form-group">
                        <label class="col-form-label pb-0">Finalidade</label>
                        <select class="cre_id_finalidades form-control form-control-line" name="cre_id_finalidades">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" class="nivel_risco form-control form-control-line" onkeyup="this.value = this.value.toUpperCase();" name="nivel_risco" placeholder="000"/>
                      </div>
                    </div>
                    <div class="col-4">
                      <div class="form-group">
                ...
                <!-- TAB4 -->
                <div class="tab-pane" id="observacoes-edit" role="tabpanel" aria-labelledby="observacoes-edit">
                  <div class="row">
                    <div class="col-10">
                      <div class="form-group">
                        ...
                        <div class="col-12 row my-auto">
                          <div class="radio radio-success my-3 mr-4">
                            <input id="checkbox-3" type="radio" name="renegociacao" class="renegociacao1" value="1" onchange="$('.renegociacao_contrato').removeAttr('disabled');">
                            <label for="checkbox-3"> Sim </label>
                          </div>
                          <div class="radio radio-success my-3">
                            <input id="checkbox-4" type="radio" name="renegociacao" class="renegociacao2"  value="0" checked onchange="$('.renegociacao_contrato').attr('disabled', 'disabled');">
                    ...
                    <div class="col-12">
                      <div class="form-group">
                        ...
                        <div class="">
                          <textarea class="observacoes form-control form-control-line" name="observacoes" rows="4" cols="33" onkeyup="this.value = this.value.toUpperCase();" placeholder="Descreva as observações do contrato"></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
