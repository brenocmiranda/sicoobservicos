...
<small class="section-header-breadcrumb d-flex">
	<div class="breadcrumb-item">
		...
		<a href="{{ route('exibir.contratos.credito') }}" class="p-0 d-block">Contratos</a>
	</div>
	<div class="breadcrumb-item d-flex activ p-0">
		<a href="{{ route('exibir.liquidados.credito') }}" class="p-0 d-block text-primary">Liquidados</a>
	</div>
</small>
@endsection
			...
			<div class="h-100 d-flex">
				<div class="col-lg-12 d-flex">
					<div>
						...
						<h6>Estão listados a abaixo todos os contratos liquidados arquivados.</h6>
					</div>
					<div class="ml-auto">
...
<script type="text/javascript">
	...
	$(document).ready( function(){
		...
		$.ajax({
			url: '{{ route("listar.liquidados.credito") }}',
			type: 'GET',
			success: function(table){
				...
				$('#table tbody').on('click', 'button#editar', function (){
					...
					$.get("garantias/"+data.id_contrato, function(dataGarantias){
