...
<small class="section-header-breadcrumb d-flex">
	...
	<div class="breadcrumb-item d-flex active p-0">
		<a href="{{ route('exibir.vigentes.credito') }}" class="p-0 d-block text-primary">Em Prejuízo</a>
	</div>
</small>
@endsection
		...
		<div class="card-body">
			<div class="h-100 d-flex">
				<div class="col-lg-12 d-flex">
					<div>
						<h3>Contratos em prejuízo</h3>
						<h6>Estão listados a abaixo todos os contratos em prejuízo arquivados.</h6>
					</div>
					<div class="ml-auto">
