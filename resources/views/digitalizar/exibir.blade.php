...
<div class="container-fluid h-100 row justify-content-center mx-auto">
	...
	<div class="row col-12 col-sm-12 col-lg-12 mx-auto py-5 justify-content-center text-center">
		<form class="form-sample" method="POST" action="{{route('digitalizar.enviar')}}" enctype="multipart/form-data" autocomplete="off">
        @csrf
	        <div>
				<div class="col-12">
					<div class="form-group">
						<label class="col-form-label text-white">Usuarios <span class="text-danger">*</span></label>
				...
				<div class="col-12">
					<div class="form-group">
						...
						<div class="row totalArquivos">
							<input type="file" name="arquivos[]" class="mb-3 text-white col-12" accept=".jpg .jpeg .png .svg">
						</div>
					</div>
